...
\setcounter{romanpages}{2} % Set this to the actual number of Roman numeral pages

\newcounter{arabicpages}
\setcounter{arabicpages}{2} % Set this to the actual number of Arabic numeral pages
...
\lipsum[2-4] % replace with your introduction content
